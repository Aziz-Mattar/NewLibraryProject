...
class PublisherController extends Controller
{
    ...
    {
        Excel::import(new PublishersImport(), 'publishers.xlsx');
        return redirect('/');
    }

    public function import2()
    {
        Excel::import(new BooksPublishersImport(), 'books_publishers.xlsx');
        return redirect('/');
    }
    ...
    public function create()
    {
        ...
        return view('control_panel.publisher.create')->with('countries', $countries)->with('ac',true);
    }
    ...
    {
        $paginate = 10;
        $publishers = Publisher::select()->paginate($paginate);
        return view('control_panel.publisher.index')->with('publishers', $publishers);
    }
...
//        dd($publisher);
        ...
        return view('control_panel.publisher.edit')->with('publisher', $publisher)->with('countries', $countries)->with('ac',false);
    }
    ...
    {
        $result = Publisher::where('id', $id)->delete();
        return redirect()
